...
import seng201.team76.models.QuestStoryChoice;
import seng201.team76.models.QuestStoryEvent;
import seng201.team76.models.StoryDrivenQuest;
...
public abstract class QuestChoiceController implements GameDataReceiver {
    ...
    /**
     * Gets the zero-based quest index this controller handles.
     *
    ...
    /**
     * Gets the title used when opening the battlefield.
     *
     * @return The quest screen title
     */
    protected abstract String getQuestScreenTitle();

    /**
     * Sets up the story screen after the FXML loads.
     */
    @FXML
    ...
    /**
     * Receives the current game and loads this quest's story data.
     *
    ...
    /**
     * Shows the final scene before the battle starts.
     */
    ...
    /**
     * Sets the story background image.
     *
    ...
    /**
     * Starts typing dialogue text to the screen.
     *
    ...
    /**
     * Finishes the current typewriter text immediately.
     */
    ...
    /**
     * Updates buttons after typewriter text finishes.
     */
    ...
    /**
     * Advances the dialogue or moves to the battlefield.
     */
    ...
    /**
     * Handles the first story choice.
     */
    @FXML
    ...
    /**
     * Handles the second story choice.
     */
    @FXML
    ...
    /**
     * Applies the selected story choice.
     *
    ...
    /**
     * Shows the two choice buttons for the current event.
     */
    ...
    /**
     * Sets button text and hover behavior for a story choice.
     *
     * @param button The button to set up
     * @param choice The story choice
     */
    ...
    /**
     * Hides the story choice buttons.
     */
    ...
    /**
     * Replaces story placeholders with game-specific names.
     *
     * @param rawText The raw story text
    ...
    private String getLivingCompanionNames() {
        ...
        for (seng201.team76.models.Adventurer member : game.getGuild().getMainParty()) {
    ...
    /**
     * Opens the battlefield screen for the current quest.
     */
