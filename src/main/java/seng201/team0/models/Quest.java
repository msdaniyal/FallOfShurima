...
public abstract class Quest {
     ...
     */
    public Quest(int id, String name, String loreIntroduction, int madnessAffliction) {
        this.id = id;
        this.name = name;
    ...
    public void updateCharacters(Guild guild) {
        // TODO: Apply loyalty delta from boss fight outcome (win/loss) to each party member
     ...
     * TODO: Call this from GameService when the previous quest is won
     */
    public void unlock() {
